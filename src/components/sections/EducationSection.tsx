    ...
    >
      ...
      >
        <div className="flex items-center gap-4 mb-2">
          ...
          <a href="#" className="text-slate-500 hover:text-cyan-400 transition-colors"><Github size={16} /></a>
          <a href="#" className="text-slate-500 hover:text-cyan-400 transition-colors"><Linkedin size={16} /></a>
        </div>
